  ...
  return (
    <div className="flex flex-col p-4 h-full">
      <div className="flex justify-end">
        <div className=" bg-[#39AA94] p-2 rounded-full my-3 inline-block cursor-pointer text-white">
          Synchronier les donnees
        </div>
      </div>
        ...
        <CardHeader>
          <CardTitle className="text-sm font-semibold">
            <div className="flex items-center justify-between ">
              <div>
                <p className="text-lg"> Données non-synchronisées</p>
        ...
        <TableBody>
          {Array.from({ length: 6 }).map((_, i) => (
            ...
            >
              ...
              <TableCell className="text-blue-600 underline">Locale</TableCell>
